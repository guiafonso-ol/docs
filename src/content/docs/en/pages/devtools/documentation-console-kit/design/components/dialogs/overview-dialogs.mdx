...
Header: keep it concise and clear, using the structure [action] + [name of instance], and short, up to 1 line. Use title case, if necessary.
Delete [nome do que será deletado]
Warning message: remarking it's an irreversible action.
Once confirmed, this action can't be reversed.
Description: clarify the consequence of the action, including the instances that will be affected, up to 2 lines.
This [nome do que será deletado] will be deleted along with any associated settings or instances. Check Help Center for more details.
...
Use the content in the Design section as a guide to this variation.
