...
Following these principles, an **edge-native platform** must be designed to operate efficiently at the edge of a network. For this reason, the platform should possess several key characteristics and functionalities to meet the unique challenges and requirements of edge computing:
