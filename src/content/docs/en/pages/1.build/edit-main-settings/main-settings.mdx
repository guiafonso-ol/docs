...
Once you create an edge application with Azion, you have a range of configurations you can modify. This guide will pick up where you left off when you [created an edge application](/en/documentation/products/guides/build/build-with-edge-application/) or [used a template](/en/documentation/products/start-with-a-template/). In this guide, you'll learn to modify the protocols, delivery ports, and the encryption type that your application uses to interface with your end-users.
...
To modify your application's delivery main settings, you must have:

- An Azion [account and credentials](/en/documentation/products/accounts/creating-account/).
- An [edge application](/en/documentation/products/guides/build/overview/).
- An [Azion or custom domain](/en/documentation/products/guides/configure-a-domain/).
...
The following steps will guide you through editing an edge application's settings. These instructions pick up where you left off from [creating an edge application](/en/documentation/products/guides/build/build-with-edge-application/), but you can modify these settings, any time you want, to fit your needs.
...
:::note
HTTPS applications require a digital certificate. Your Azion domain is automatically protected by the Azion SAN certificate, but if you wish to [customize your domain](/en/documentation/products/guides/configure-a-domain/), you'll need a [custom certificate](/en/documentation/products/guides/create-a-digital-certificate/) as well.
:::
...
Once again, it may take some time to propagate your changes to the edge. To verify whether your changes took place, you can inspect the page using your browser and locate the security settings of the application. You can also [run the DIG command](/en/documentation/products/guides/run-the-dig-command/) to get more information on your security settings.
...
Modules can unlock additional functionalities and features for your applications. See the [Pricing page](https://www.azion.com/en/pricing/) for more information on how they are priced. 

For now, you'll enable two modules. The modules **Application Acceleration** and **Edge Functions** will be used for when you [tune your cache settings](/en/documentation/products/guides/build/tune-cache-settings/), [instantiate an edge function](/en/documentation/products/guides/build/instantiate-edge-functions/), and [work with Rules Engine](/en/documentation/products/guides/build/work-with-rules-engine/). If you're an [Account owner](/en/documentation/products/guides/users-management/), start by enabling them for your account:
...
:::note
To check all available values for this endpoint, see the [Azion API](https://api.azion.com) documentation.
:::
