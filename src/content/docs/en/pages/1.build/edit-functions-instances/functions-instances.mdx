...
Instantiate serverless functions created with [Edge Functions](/en/documentation/products/edge-application/edge-functions/) directly within your edge application. 

<Button href="/en/documentation/products/edge-application/edge-functions-instances/" variant="secondary" text="Go to Edge Functions Instances documentation"></Button>

:::caution[warning]
You must activate the [Edge Functions](/en/documentation/products/edge-application/application-acceleration/) module to implement functions in your application. If **Edge Functions** is activated, computing time and invocations could generate usage-related costs. Check the [pricing page](https://www.azion.com/en/pricing/) for more information.
:::

To instantiate and run a function, you must have:
...
Now you're able to instantiate edge functions. You can [create a function using Edge Functions](/en/documentation/products/edge-application/edge-functions/), but this guide will use the pre-configured *Azion - Hello World* function, a global function included in all Azion accounts.
...
1. Run the following `PATCH` request in your terminal, replacing `[TOKEN VALUE]` with your personal token and the `<edge_application_id>` variable with the `id` of your edge application to activate the [Edge Functions](/en/documentation/products/edge-application/edge-functions/) module:
