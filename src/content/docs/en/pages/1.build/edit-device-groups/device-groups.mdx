...
<Button href="/en/documentation/products/edge-application/device-groups/" text="Go to Device Groups documentation" variant="secondary"></Button>

To create a device group for your edge application, you must have:
