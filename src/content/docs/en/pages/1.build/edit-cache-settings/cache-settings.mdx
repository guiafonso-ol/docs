...
Instead of downloading a large content file and risking timeouts or connection terminations, files can be sliced in pieces and cached on-demand. To implement file slicing for large files:
