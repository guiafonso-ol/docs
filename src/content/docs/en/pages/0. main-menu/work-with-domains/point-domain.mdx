...
:::note
This process will require you to associate a CNAME record to your domain. See [Migrate your DNS to Azion](/en/documentation/products/guides/migrate-ns-to-azion/) for more information on how to associate an ANAME type record.
:::
...
- A [custom domain](/en/documentation/products/guides/configure-a-domain/#link-a-custom-domain-to-your-application).
...
Before you run the API, you'll need a personal token. See the [Azion API documentation](/en/documentation/products/guides/personal-tokens/) for more information.
