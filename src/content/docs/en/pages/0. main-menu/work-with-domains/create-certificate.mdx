...
<Button href="/en/documentation/products/edge-application/digital-certificates/" variant="secondary" text="Go to Digital Certificates documentation"></Button>
...
Before you run the Azion API, you need to [generate a personal token](/en/documentation/products/guides/personal-tokens/) for your account.
