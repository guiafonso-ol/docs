...
<Button href="/en/documentation/products/intelligent-dns/" variant="secondary" text="Go to Intelligent DNS documentation"></Button>
...
Before you transfer your DNS resolution Azion, you must have:
...
- An [Azion domain](/en/documentation/products/guides/configure-a-domain/).
