...
:::note
If you want to create your own local development server, read the [Azion CLI's dev command](/en/documentation/products/cli/dev-command/) documentation for more details.
:::
